...
function initParentCategorySelect(){
	$.ajax({
        type : 'get',
        url : '/categorys/parents',
        async : false,
        success : function(data) {
            var select = $("#parentId");
            select.append("<option value='0'>一级分类</option>");
            for(var i=0; i<data.length; i++){
                var d = data[i];
                var id = d['id'];
                var name = d['name'];
...
function initParentCategorySelect2(){
	$.ajax({
        type : 'get',
        url : '/categorys/parents',
        async : false,
...
function initCustomerHerdsmanSelect(){
	$.ajax({
        type : 'get',
        url : '/herdsmaninfos/customerHerdsmans',
        async : false,
        success : function(data) {
            var select = $("#parentId");
            for(var i=0; i<data.length; i++){
