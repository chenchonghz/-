package com.orhonit.admin.server.config;
...
import com.orhonit.admin.server.filter.LogoutFilter;
import com.orhonit.admin.server.filter.RestfulFilter;
import com.orhonit.admin.server.sys.config.MyShiroRealm;
...
public class ShiroConfiguration {
	...
	public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/districts/**", "anon");
